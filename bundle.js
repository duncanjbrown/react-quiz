...
/***/ function(module, exports, __webpack_require__) {
	...
	var _immutable = __webpack_require__(168);

	var _quiz = __webpack_require__(169);
	...
	var questions = (0, _immutable.List)([(0, _immutable.Map)({
	    id: 0,
	...
	var store = (0, _redux.createStore)(_reducer.reducer, questions);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _Quiz = __webpack_require__(192);

	var _Quiz2 = _interopRequireDefault(_Quiz);

	function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

	var QuizApp = (0, _reactRedux.connect)(function mapStateToProps(state) {
	  return { questions: state };
	}, function mapDispatchToProps(dispatch) {
	  return {
	    answerQuestion: function answerQuestion(x, y) {
	      return console.log("answer", x, y);
	    }
	  };
	})(_Quiz2.default);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _Question = __webpack_require__(193);
	...
	var Quiz = function Quiz(_ref) {
	    ...
	    var answerQuestion = _ref.answerQuestion;
	    return _react2.default.createElement(
	        ...
	        _react2.default.createElement(
	            ...
	            questions.map(function (question, i) {
	                return _react2.default.createElement(_Question2.default, { question: question, answerQuestion: answerQuestion, key: i });
	            })
	        )
	    );
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _Answer = __webpack_require__(194);
	...
	var Question = function Question(_ref) {
	    ...
	    var onAnswer = function onAnswer(id) {
	        return function () {
	    ...
	    return _react2.default.createElement(
	        ...
	        _react2.default.createElement(
	            ...
	            question.get('answers').map(function (a, i) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	function reducer() {
	  var state = arguments.length <= 0 || arguments[0] === undefined ? emptyList : arguments[0];
	  var action = arguments[1];

	  switch (action.type) {
	    case 'ANSWER_QUESTION':
	      return state.map(function (q) {
	        return question(q, action);
	      });
	    default:
	      return state;
	  }
	...
	function question(state, action) {
	  switch (action.type) {
	    case 'ANSWER_QUESTION':
	      ...
	      var answer = state.answers[action.answerID];
